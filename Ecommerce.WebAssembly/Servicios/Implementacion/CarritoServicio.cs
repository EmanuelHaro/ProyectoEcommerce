    ...
    public class CarritoServicio: ICarritoServicio
    {
        ...
        public async Task AgregarCarrito(CarritoDTO modelo)
        {
            try
            {
                ...
                if (encontrado != null) 
                    carrito.Remove(encontrado); //Problema de duplicidad de producto dentro del carrito
                ...
                MostrarItems.Invoke(); //Cambia a 1
            }
            catch 
            {
        ...
        public int CantidadProductos()
        {
            ...
            return carrito == null ? 0 : carrito.Count; //si es nulo returna 0, caso contrario count
